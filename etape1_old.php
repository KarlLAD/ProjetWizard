...
<body>
    ...
    // la connexion à la base de données
        ...
        //    $update_time= $_POST['update_time'];
           ...
           $sql = ("INSERT INTO `addresstier`(  `nameTier`, `address1`, `zip`, `city`, `phone`, `mobile`, 
           `country`, `dpt`, `Email`) 
                        VALUES(  :nameTier, :address1, : zip, :city, :phone, :mobile, :country, :dpt, :Email )");
...
?>
    ...
    <section class="etape1">
        ...
        <form action="#" @csrf method="POST">
            ...
            <input type="submit" value="suivant2" name="suivant2">
